# -*- coding: utf-8 -*-
"""
Created on Tue Sep 24 16:16:30 2024
...
best_xgb_model = XGBClassifier(
    ...
    n_estimators=200,
    subsample=0.8,
    use_label_encoder=False,  # Avoids a warning related to label encoding
...
print(f"Best Parameters: {best_xgb_model.get_params()}")
...
roc_data.to_csv(data_res / 'XGBoost_roc_data.csv', index=False)
