# -*- coding: utf-8 -*-
"""
Created on Wed Sep 25 11:22:25 2024
...
best_adaboost_model = AdaBoostClassifier(n_estimators=500, learning_rate=1.0)
...
roc_data.to_csv(data_res / 'AdaBoost_roc_data.csv', index=False)
